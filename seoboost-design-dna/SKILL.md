...
> **Sumber:** Divendor dari [zanwei/design-dna](https://github.com/zanwei/design-dna) (MIT License). Melengkapi (bukan menggantikan) `frontend-design` (natif) dan `impeccable` — dipakai saat perlu reverse-engineer referensi UI eksternal jadi design token terstruktur.
